        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Streams_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistId = table.Column<int>(nullable: true),
                    Date = table.Column<DateTime>(nullable: true),
                    GanrId = table.Column<int>(nullable: true),
                    Longtime = table.Column<TimeSpan>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Records_Ganrs_GanrId",
                        column: x => x.GanrId,
                        principalTable: "Ganrs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Records_Streams_MusicId",
                        column: x => x.MusicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Records_GanrId",
                table: "Records",
                column: "GanrId");

            migrationBuilder.CreateIndex(
                name: "IX_Records_MusicId",
                table: "Records",
                column: "MusicId");
